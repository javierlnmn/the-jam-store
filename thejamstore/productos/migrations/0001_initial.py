...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddField(
            ...
            field=models.ForeignKey(blank=True, limit_choices_to={'categoria_padre': models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='productos.categoria')}, null=True, on_delete=django.db.models.deletion.SET_NULL, to='productos.tipo_prenda'),
        ),
        migrations.AddField(
            model_name='producto',
            name='talla',
